...
namespace VS.E_Commerce.cms.Display.Allbums
{
    public partial class index : System.Web.UI.UserControl
    {
        ...
        {
            return SAlbum.Name_Text("select top " + MoreAll.Other.Giatri("txtHomePagealbum") + " * from  Album where News=1 and Menu_ID in (" + More.Sub_Menu(More.AB, icid) + ") and Status=1   order by Create_Date desc");
        }
