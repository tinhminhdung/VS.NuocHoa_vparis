...
namespace VS.E_Commerce.cms.Admin
{
    public partial class index1 : System.Web.UI.Page
    {
        ...
        protected void LinkButton4_Click(object sender, EventArgs e)
        {
            ...
            {
                this.txt_order.Text = More.GetNextCateOrder(More.VP, this.lang, "-1").ToString();
            }
            else
            {
                this.txt_order.Text = More.GetNextCateOrder(More.VP, this.lang, hd_id.Value).ToString();
            }
        ...
        private void ShowList()
        {
            try
            {
                ...
                List<Entity.Menu> table = SMenu.Name_Text("SELECT * FROM Menu where capp='" + More.VP + "' and lang='" + lang + "' order by level,Orders asc");
