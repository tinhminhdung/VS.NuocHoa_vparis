<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Manufacturer.ascx.cs" Inherits="VS.E_Commerce.cms.Admin.Products.Manufacturer" %>
            ...
            <div id="">
                <div class="Block Breadcrumb ui-widget-content ui-corner-top ui-corner-bottom" id="Breadcrumb">
                    <ul>
                        ...
                        <li class="Last"><span>Hãng (Thương hiệu) sản phẩm</span></li>
                    </ul>
                </div>
                ...
                <div class="widget">
                    <asp:Panel ID="pn_list" runat="server" Width="100%">
                        <div class="widget-title">
                            <h4><i class="icon-list-alt"></i>&nbsp;Danh sách Hãng (Thương hiệu) </h4>
