<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Size.ascx.cs" Inherits="VS.E_Commerce.cms.Admin.Products.Size" %>
            ...
            <div id="">
                <div class="Block Breadcrumb ui-widget-content ui-corner-top ui-corner-bottom" id="Breadcrumb">
                    <ul>
                        ...
                        <li class="Last"><span>Danh sách kích cỡ</span></li>
                    </ul>
                </div>
                ...
                <div class="widget">
                    <asp:Panel ID="pn_list" runat="server" Width="100%">
                        <div class="widget-title">
                            <h4><i class="icon-list-alt"></i>&nbsp;Danh sách kích cỡ </h4>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox ID="txtTennhom" Style="border: 1px solid #d7d7d7; border-radius: 3px; text-align: left; width: 50%; height: 20px" TextMode="MultiLine" Text='<%#DataBinder.Eval(Container.DataItem, "Name")%>' CssClass="txt_css" Width="40px" runat="server" OnTextChanged="txtTennhom_TextChanged" AutoPostBack="true"></asp:TextBox>
                                            </td>
                                            <td style="text-align: center;">
