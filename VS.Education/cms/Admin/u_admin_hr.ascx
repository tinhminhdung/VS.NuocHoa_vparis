            ...
            <div>
                <ul class="sysMenu">
                    ...
                    <asp:Repeater ID="rplangs" runat="server" OnItemCommand="rplangs_ItemCommand">
                        <ItemTemplate>
                            <li class="ngonngu"><asp:LinkButton ID="LinkButton1" CssClass='<%#langcss(Eval("VLAN_ID").ToString()) %>' CommandName="change" CommandArgument='<%#Eval("VLAN_ID")%>' runat="server"> <img src="/Resources/languages/<%#Eval("VLAN_ID")%>.gif" /></asp:LinkButton></li>
                        </ItemTemplate>
                    </asp:Repeater>
