                                            ...
                                            <div id="sample_1_length" class="dataTables_length">
                                                ...
                                                <asp:DropDownList ID="ddlvalue" runat="server" AutoPostBack="true" Style="width: auto" OnSelectedIndexChanged="ddlvalue_SelectedIndexChanged">
                                                    <asp:ListItem Value="1">Slide chính - Trang chủ</asp:ListItem>
                                                      <asp:ListItem Value="2">Quảng cáo menu trái</asp:ListItem>
                                                     <asp:ListItem Value="3">Mạng chia sẻ trên top đầu menu</asp:ListItem>
                                                 <%--   <asp:ListItem Value="4">Banner trên đầu tìm kiếm</asp:ListItem>--%>
                                         <%--           <asp:ListItem Value="5">Icon Trên Mobile dạng 1</asp:ListItem>
                                                    <asp:ListItem Value="6">Icon Trên Mobile dạng 2</asp:ListItem>--%>
                                                     <asp:ListItem Value="7">Logo Trên Mobile</asp:ListItem>
                                                      <asp:ListItem Value="8">Cảm nhận khách hàng</asp:ListItem>
                                                </asp:DropDownList>
