...
{
    public partial class DMAdvertising : System.Web.UI.UserControl
    {
        ...
        protected void LoadCategories()
        {
            try
            {
                ...
                int str = 0;
                List<Entity.Menu> dt = SMenu.Name_Text("SELECT * FROM [Menu]  where capp='" + More.PR + "' and Lang='" + this.lang + "'  and Parent_ID=-1 and Status=1 order by Orders asc");
        ...
        {
            LoadItems();
            Response.Redirect("admin.aspx?u=Advertisings&su=DMAdvertising&value=" + ddlvalue.SelectedValue + "&st=" + ddlstatus.SelectedValue + "");
        }
