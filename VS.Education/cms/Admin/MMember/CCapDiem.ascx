<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CCapDiem.ascx.cs" Inherits="VS.E_Commerce.cms.Admin.MMember.CCapDiem" %>
            ...
            <div id="">
                <div class="Block Breadcrumb ui-widget-content ui-corner-top ui-corner-bottom" id="Breadcrumb">
                    <ul>
                        ...
                        <li class="Last"><span>Cấp điểm cho thành viên</span></li>
                    </ul>
                </div>
                ...
                <div class="widget">
                    <asp:Panel ID="pn_list" runat="server" Width="100%">
                        <div class="widget-title">
                            <h4><i class="icon-list-alt"></i>&nbsp;Cấp điểm cho thành viên</h4>
                        ...
                        <div class="widget-body">
                            <div class="row-fluid">
                                <div class="span9">
                                    ...
                                    <div class="dataTables_length" id="sample_1_length">
                                        ...
                                        <asp:DropDownList runat="server" ID="ddlkieuvi" AutoPostBack="true" OnSelectedIndexChanged="ddlkieuvi_SelectedIndexChanged">
                                            <asp:ListItem Value="0" Selected="True">-- Tất cả ví --</asp:ListItem>
                                            <asp:ListItem Value="1">Ví Chính</asp:ListItem>
                                            <asp:ListItem Value="2">Ví Vip</asp:ListItem>
                                            <asp:ListItem Value="3">Ví VPR-S</asp:ListItem>
                                        </asp:DropDownList>
                                        <asp:DropDownList runat="server" ID="ddlKieuCongTru" AutoPostBack="true" OnSelectedIndexChanged="ddlKieuCongTru_SelectedIndexChanged">
                                            <asp:ListItem Value="0" Selected="True">-- Tất cả Cộng & Trừ --</asp:ListItem>
                                            <asp:ListItem Value="1">Cộng </asp:ListItem>
                                            <asp:ListItem Value="2">Trừ</asp:ListItem>
                                        </asp:DropDownList>
                                        <div>
                            ...
                            <div style="color: red; font-weight: bold; font-size: 14px;">Lưu ý: Trừ ví sẽ không hiển thị lịch sử của thành viên mà chỉ admin mới nhìn thấy</div>
                            <div class="list_item">
                                <asp:Repeater ID="rp_pagelist" runat="server" OnItemCommand="rp_pagelist_ItemCommand">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <%#MoreAll.MoreAll.CongTRu(DataBinder.Eval(Container.DataItem, "CongTRu").ToString())%>
                                            </td>
                                            <td style="text-align: center;">
                                        ...
                                        <table cellspacing="0" style="border-collapse: collapse; margin-top: 18px" class="table table-striped table-bordered dataTable table-hover">
                                            <tbody>
                                                <tr class="trHeader" style="height: 25px">
                                                    ...
                                                    <th style="font-weight: bold">Số tiền / điểm</th>
                                                    <th style="font-weight: bold">Cộng % Trừ</th>
                                                    <th style="font-weight: bold">Loại ví</th>
                        ...
                        <div class="widget-body">
                            ...
                            <div class='frm-add'>
                                <table class="Tables">
                                    ...
                                    <tr>
                                        <td align="left">Chọn kiểu +&-
                                        </td>
                                        <td></td>
                                        <td>
                                            <asp:DropDownList ID="ddlCongTru" runat="server" CssClass="txt">
                                                <asp:ListItem Selected="True" Value="0">= Chọn công thức =</asp:ListItem>
                                                <asp:ListItem Value="1">Cộng </asp:ListItem>
                                                <asp:ListItem Value="2">Trừ</asp:ListItem>
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator21" runat="server" ErrorMessage="Vui lòng chọn kiểu" Text="Vui lòng chọn kiểu" InitialValue="0" ControlToValidate="ddlCongTru" ValidationGroup="GInfo"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left">Ví 
                                        ...
                                        <td></td>
                                        <td>
                                            <asp:DropDownList ID="ddlViThuong" runat="server" CssClass="txt">
                                                <asp:ListItem Value="1">Ví Chính </asp:ListItem>
                                                <asp:ListItem Value="2">Ví Vip (Thưởng)</asp:ListItem>
                                                 <asp:ListItem Value="3">Ví VPR-S</asp:ListItem>
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Vui lòng chọn kiểu" Text="Vui lòng chọn ví thưởng" InitialValue="0" ControlToValidate="ddlViThuong" ValidationGroup="GInfo"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left">Số tiền
                                        </td>
                                        <td></td>
                                        <td>
                                            ...
                                            <span style="font-size: 8pt; color: #ed1c24"><em>(Chú ý : Đối với ví VPR-S là điểm chứ ko phải số tiền nhé)</em></span>
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td>
                                            <asp:TextBox ID="txtnoidung" CssClass="txt_css" runat="server" Width="392px"
                                                Height="35px" TextMode="MultiLine"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" SetFocusOnError="true" runat="server" ValidationGroup="GInfo" ControlToValidate="txtnoidung" ErrorMessage="*"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
