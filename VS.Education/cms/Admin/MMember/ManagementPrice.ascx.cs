...
namespace VS.E_Commerce.cms.Admin.MMember
{
    public partial class ManagementPrice : System.Web.UI.UserControl
    {
        ...
        protected void btn_InsertUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                if (this.txt_title.Text.Trim().Length < 1 && this.CoPhan.Text.Trim().Length < 1 && this.txttu.Text.Trim().Length < 1 && this.txtden.Text.Trim().Length < 1)
                {
                ...
                case "EditDetail":
                    ...
                    if (table.Count > 0)
                    {
                        ...
                        if (table.Count > 0)
                        {
                            ...
                            this.CoPhan.Text = table[0].Description.ToString().Trim();
