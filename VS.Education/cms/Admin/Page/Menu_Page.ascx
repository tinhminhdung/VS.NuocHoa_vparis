                            ...
                            <div class="span8">
                                <div class="dataTables_filter" id="sample_1_filter">
                                    <asp:DropDownList runat="server" ID="ddlPage" AutoPostBack="true" OnSelectedIndexChanged="ddlPage_OnSelectedIndexChanged">
                                        ...
                                        <asp:ListItem Value="10">10 Bản ghi / trang</asp:ListItem>
                                        <asp:ListItem Value="20">20 Bản ghi / trang</asp:ListItem>
                                        <asp:ListItem Value="30">30 Bản ghi / trang</asp:ListItem>
                                        <asp:ListItem Value="40">40 Bản ghi / trang</asp:ListItem>
                                    ...
                                    <asp:DropDownList ID="drlFilterVitri" AutoPostBack="true"  OnSelectedIndexChanged="drlFilterVitri_SelectedIndexChanged" runat="server" Font-Names="Tahoma" Font-Size="9pt" ForeColor="#003366">
                                        ...
                                        <asp:ListItem Value="2">Menu dưới</asp:ListItem>
                                    </asp:DropDownList>
                        ...
                        <div class="list_item">
                            <table cellspacing="0" style="border-collapse: collapse; margin-top: 18px" class="table table-striped table-bordered dataTable table-hover">
                                <tr height="22">
                                    ...
                                    <th class="header">Tên menu
                                    </th>
                                    <th class="header">Thuộc cấp
                                    </th>
                                    <th class="header">Kiểu menu
                                    </th>
                                        ...
                                        <tr height="40">
                                            <td style="text-align: center;">
                                             ...
                                             <td style="text-align: center;" class="Imgsmall">
                                               <%#MoreAll.MoreImage.Image_width_height(Eval("Noidung5").ToString(),"30","30")%></a>
                                           </td>
                                            
                                              <td>
                                                <%#MoreAll.Other.Hienthihinhcay("", DataBinder.Eval(Container.DataItem, "Level").ToString())%>
                                                <asp:TextBox ID="TextBox2" runat="server"  Style="border: 1px solid #d7d7d7; border-radius: 3px; text-align: left; width:80%;" TextMode="MultiLine" OnTextChanged="Name_TextChanged" AutoPostBack="true" Text='<%#DataBinder.Eval(Container.DataItem, "Name")%>'></asp:TextBox>
                                            </td>
                                            <td class="center">
                                            ...
                                            <td align="left" style="text-align: center; padding-left: 5px; width: 200px">
                                            ...
                                            <td align="center" style="text-align: center;">
                                                <asp:TextBox ID="txtThutu" CssClass="TTinput" runat="server" Style="text-align: center; width: 20px" onkeyup="valid(this,'quotes')" onblur="valid(this,'quotes')" OnTextChanged="txtThutu_TextChanged" AutoPostBack="true" Text='<%#DataBinder.Eval(Container.DataItem, "Orders")%>'></asp:TextBox>&nbsp;&nbsp;&nbsp;</td>
                                            <td style="text-align: center;">
                                    ...
                                    <div class="widget-body">
                                        ...
                                        <table class="Tables">
                                            ...
                                            <asp:Panel ID="pnKieulienket" runat="server" Visible="false">
                                                ...
                                                <asp:Panel ID="pnNhom" runat="server" Visible="false">
                                                    <tr>
                                                        ...
                                                        <td class="lerightadd">
                                                            <asp:DropDownList ID="drlgrnId" runat="server" CssClass="Nselect">
                                                            </asp:DropDownList>
                                                ...
                                                <asp:Panel ID="pnpro" runat="server" Visible="false">
                                                    <tr>
                                                        ...
                                                        <td class="lerightadd">
                                                            <asp:DropDownList ID="drlCategory" runat="server" CssClass="Nselect">
                                                            </asp:DropDownList>
                                                ...
                                                <asp:Panel ID="pnLibrary" runat="server" Visible="false">
                                                    <tr>
                                                        ...
                                                        <td class="lerightadd">
                                                            <asp:DropDownList ID="drlLibrary" runat="server" CssClass="Nselect">
                                                            </asp:DropDownList>
                                            ...
                                            <asp:Panel ID="pnNoidung" runat="server" Visible="false">
                                                ...
                                                <tr>
                                                    <td align="left"><span style=" color:#ff0000">Icon menu trên</span>
                                        </td>
                                                    <td class="lerightadd">
                                                        <asp:TextBox ID="txtImg1" runat="server"></asp:TextBox>
                                                        <input id="btnBrowse1" type="button" value="Browse" onclick="BrowseServer('<%=txtImg1.ClientID %>','news');" class="toolbar btns btn-info" />
