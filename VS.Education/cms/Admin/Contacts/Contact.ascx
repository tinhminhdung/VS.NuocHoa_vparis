                ...
                <div class="row-fluid">
                    <div class="span6">
                        ...
                        <div class="dataTables_filter" id="sample_1_filter">
                            <asp:LinkButton ID="btndisplay" runat="server" OnClick="btndisplay_Click" Text="Root Cate" CssClass="vadd toolbar btn btn-info"> <i class=" icon-folder-close"></i>&nbsp;Hiển thị</asp:LinkButton>
