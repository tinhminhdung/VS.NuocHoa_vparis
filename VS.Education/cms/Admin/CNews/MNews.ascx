                            ...
                            <tr class="odd gradeX">
                                <td class="hidden-phone">
                                 ...
                                 <td style="text-align:center"  class="Imgsmall">
                                   ...
                                   <%-- <div> <span style="font-size: 7pt; color:#fe8209">(<%#MoreAll.MoreNews.AllComments(Eval("inid").ToString(), "0")%>)</span> <%#Comments(Eval("inid").ToString())%> <span style="font-size: 7pt; color:red">(<%#MoreAll.MoreNews.AllComments(Eval("inid").ToString(), "1")%>)</span></div>  --%>
                                </td>
                                <td>
