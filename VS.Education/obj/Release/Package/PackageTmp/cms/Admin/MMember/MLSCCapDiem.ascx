<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MLSCCapDiem.ascx.cs" Inherits="VS.E_Commerce.cms.Admin.MMember.MLSCCapDiem" %>
    ...
    <div id="">
        <div class="Block Breadcrumb ui-widget-content ui-corner-top ui-corner-bottom" id="Breadcrumb">
            <ul>
                ...
                <li class="Last"><span>Lịch sử cấp điểm cho thành viên</span></li>
            </ul>
        </div>
        <div style="clear: both;"></div>
        <div class="widget">
            <div class="widget-title">
                <h4><i class="icon-list-alt"></i>&nbsp;Lịch sử cấp điểm cho thành viên</h4>
            </div>
                ...
                <div class="list_item">
                    <table cellspacing="0" style="border-collapse: collapse; margin-top: 18px" class="table table-striped table-bordered dataTable table-hover">
                        <tbody>
                            ...
                            <tr>
                                <td style="text-align: right; color: red; font-weight: bold" colspan="5">Tổng cộng :
