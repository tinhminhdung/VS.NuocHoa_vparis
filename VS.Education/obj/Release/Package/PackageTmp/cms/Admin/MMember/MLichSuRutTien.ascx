<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MLichSuRutTien.ascx.cs" Inherits="VS.ECommerce_MVC.cms.Admin.MMember.MLichSuRutTien" %>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                         ...
                                         <%--   <td style="text-align: center;">
                                            ...
                                            <td style="text-align: center;">
                                                 <%#MoreAll.MorePro.FormatMoney_VND(DataBinder.Eval(Container.DataItem, "SoTienCanRut").ToString())%>
                                            </td>
                                              <td style="text-align: center;">
                                                   <%#MoreAll.MorePro.FormatMoney_VND(DataBinder.Eval(Container.DataItem, "SoCoin").ToString())%>
                                                    </td>
                                            <td style="text-align: center;">
