            ...
            <div class='frm-add'>
                <table style="border-collapse: collapse" cellpadding="0" width="100%" border="0">
                    ...
                    <tr style="display:none">
                        <td></td>
                        <td style="padding-left: 15px">Seo , h1,h2,h3,h4
                        </td>
                        <td>
                    ...
                    <tr>
                     ...
                     <tr>
                      ...
                      <tr>
                        <td></td>
                        <td style="padding-left: 15px">Đặt hàng thành công
                        </td>
                        <td>
                            <CKEditor:CKEditorControl ID="dathangthanhcong" runat="server" Toolbar="Basic"></CKEditor:CKEditorControl>
                        </td>
                        </td>
                    </tr>
                     <tr>
                        <td></td>
                        <td style="padding-left: 15px">Đặt hàng thành công thiếu tiền trong ví
                        </td>
                        <td>
                            <CKEditor:CKEditorControl ID="DatHangThieuTien" runat="server" Toolbar="Basic"></CKEditor:CKEditorControl>
                        </td>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td></td>
                        <td style="width: 143px">Nội dung dưới Foooter
                        </td>
                        <td>
