    ...
    <div class="widget">
        ...
        <div class="widget-body">
            ...
            <table style="border-collapse: collapse" cellpadding="0" width="100%" border="0">
                ...
                <tr>
                    <td></td>
                    <td style="padding-left: 15px">Email nhận
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input id="btnlogo" type="button" onclick="BrowseServer('<%=txtlogo.ClientID %>','News');" value="Browse Server" class="toolbar btns btn-info" />
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input id="btnnoimgaes" type="button" onclick="BrowseServer('<%=txtnoimgaes.ClientID %>','News');" value="Browse Server" class="toolbar btns btn-info" />
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input id="btnicon" type="button" onclick="BrowseServer('<%=txticon.ClientID %>','News');" value="Browse Server" class="toolbar btns btn-info" />
                ...
                <tr>
                 ...
                 <tr>
                    <td></td>
                    <td style="padding-left: 15px">Sologan
                    </td>
                    <td>
                        <asp:TextBox CssClass="txt_css" placeholder="Sologan" ID="txtSologan" runat="server" Width="550px"
                ...
                <tr>
                    ...
                    <td></td>
                    <td>
                        <asp:LinkButton ID="btnsetup" runat="server" OnClick="btnsetup_Click" CssClass="toolbar btn btn-info"> <i class="icon-ok"></i>Cập nhật</asp:LinkButton>
                        <asp:LinkButton ID="btsitemap"  runat="server" OnClick="btsitemap_Click" CssClass="toolbar btn btn-info"> <i class="icon-ok"></i>Cập nhật Sitemap</asp:LinkButton>
                    </td>
                </tr>
                <tr>
                    <td></td>
