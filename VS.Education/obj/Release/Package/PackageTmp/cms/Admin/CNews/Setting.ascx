                    ...
                    <div class="span12">
                        <div class="widget">
                            ...
                            <span class="capnhatphai">
                                <asp:LinkButton ID="btnupdate" runat="server" OnClick="btnupdate_Click" CssClass="btn btn-primary"> <i class="icon-pencil icon-white"></i> Cập nhật </asp:LinkButton>
                            </span>
                            ...
                            sách tin)</em></span>
                                        ...
                                        <tr style=" display:none">
                                            <td style="padding-left: 15px">Chia sẻ bài viết
                                            </td>
                                            <td></td>
                                            <td>
                                                ...
                                                <span style="font-size: 8pt; color: #ed1c24"><em>(Xuất hiện các icon để chia sẻ (Bookmark & Share) - Ex:facebook,Tweet this,vv...)<img src="Uploads/pic/web/chiase.jpg" border="0" /></em></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td></td>
                                            <td>
                                                <asp:LinkButton ID="btnsetup" runat="server" OnClick="btnsetup_Click" CssClass="btn btn-primary"> <i class="icon-pencil icon-white"></i> Cập nhật </asp:LinkButton>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
