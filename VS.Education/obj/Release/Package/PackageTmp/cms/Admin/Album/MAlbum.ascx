                                            ...
                                            <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                               ...
                                               <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input id="btnImage" type="button" onclick="BrowseServer('<%=txtImages.ClientID %>','News');" value="Browse Server" class="toolbar btns btn-info" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            ...
                                                            <input id="btnBrowseImage" onclick="BrowseServerNew('<%=txtMImage.ClientID %>','News')" type="button" value="Browse Server" class="toolbar btns btn-info" />
