<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StatusCode.ascx.cs" Inherits="VS.E_Commerce.cms.Admin.Redirect301.StatusCode" %>
            ...
            <div id="">
                <div class="Block Breadcrumb ui-widget-content ui-corner-top ui-corner-bottom" id="Breadcrumb">
                    <ul>
                        ...
                        <li class="Last"><span>Status Code 301 </span></li>
                    </ul>
                </div>
                ...
                <div class="widget">
                    <asp:Panel ID="pn_list" runat="server" Width="100%">
                        <div class="widget-title">
                            <h4><i class="icon-list-alt"></i>&nbsp;Danh sách chuyển hướng 301 </h4>
                                        ...
                                        <table class="toolbar">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <asp:Button ID="btn_Homepage" CssClass="vadd toolbar btn btn-info" Visible="false" runat="server" OnClick="btn_Homepage_Click" Text="Root Cate" /></td>
                                                    <td align="center">
                                                        <asp:Button ID="btn_back" CssClass="vadd toolbar btn btn-info" Visible="false" runat="server" OnClick="btn_back_Click" Text="<<< Back" /></td>
                                                    <td align="center">
                                ...
                                <asp:Repeater ID="rp_pagelist" runat="server" OnItemCommand="rp_pagelist_ItemCommand" >
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                          <a href=" <%#DataBinder.Eval(Container.DataItem, "Name")%>" target="_blank"> <%#DataBinder.Eval(Container.DataItem, "Name")%></a>
                                            </td>
                                           <td>
                                        ...
                                        <table cellspacing="0" style="border-collapse: collapse; margin-top: 18px" class="table table-striped table-bordered dataTable table-hover">
                                            <tbody>
                                                <tr class="trHeader" style="height: 25px">
                                                    ...
                                                    <th style="font-weight: bold">Link Cũ </th>
                                                    <th style="font-weight: bold">Link Mới</th>
                        ...
                        <div class="widget-body">
                            ...
                            <div class='frm-add'>
                                <table class="Tables">
                                    ...
                                    <tr>
                                        <td align="left">Link mới thay thế
                                        </td>
                                        <td></td>
                                        <td>
                                            <asp:TextBox ID="txtcontent" CssClass="txt_css" runat="server" Width="320px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td>
                                            <b style=" color:red"> Bắt buộc phải có trong link : <asp:Literal ID="ltluy" runat="server"></asp:Literal></b>
                                        </td>
                                    </tr>
...
<div style=" color:red; font-size:13px">(Lưu ý: Chỉ áp dụng cho phần này khi bên (<i style="  font-weight:bold; color:#000000">Quản trị --> Cấu hình ---> Cài đặt thuộc tính</i>) đã bật tính năng (<b  style="  font-weight:bold; color:#5f9902">Bật chuyển trang page 404 và Áp dụng chuyển trang 301</b>))</div>
