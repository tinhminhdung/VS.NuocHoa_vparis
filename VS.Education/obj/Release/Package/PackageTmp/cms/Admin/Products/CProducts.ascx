<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CProducts.ascx.cs" Inherits="VS.E_Commerce.cms.Admin.Products.CProducts" %>
            ...
            <div id="">
                <div class="Block Breadcrumb ui-widget-content ui-corner-top ui-corner-bottom" id="Breadcrumb">
                    <ul>
                        ...
                        <li class="Last"><span>Nhóm sản phẩm</span></li>
                    </ul>
                </div>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            <td style="text-align: center;">
                                             ...
                                             <td style="text-align: center;" class="Imgsmall">
                                               <%#MoreAll.MoreImage.Image_width_height(Eval("Noidung1").ToString(),"30","30")%></a>
                                           </td>
                                           <td>
                                            ...
                                            <td style="text-align: center;">
                                                <asp:LinkButton CssClass="active action-link-button" CommandName="page_Home" CommandArgument='<%#Eval("ID")+"|"+Eval("page_Home")%>' runat="server" ID="Linkbutton6"><%#MoreAll.MoreAll.Enable(DataBinder.Eval(Container.DataItem, "page_Home").ToString())%></asp:LinkButton>
                                            </td>
                                             <td style="text-align: center;">
                                                <asp:LinkButton CssClass="active action-link-button" CommandName="News" CommandArgument='<%#Eval("ID")+"|"+Eval("News")%>' runat="server" ID="Linkbutton7"><%#MoreAll.MoreAll.Enable(DataBinder.Eval(Container.DataItem, "News").ToString())%></asp:LinkButton>
                                            </td>
                                    ...
                                    <HeaderTemplate>
                                        <table cellspacing="0" style="border-collapse: collapse; margin-top: 18px" class="table table-striped table-bordered dataTable table-hover">
                                                <tr class="trHeader" style="height: 25px">
                                                    ...
                                                    <th style="font-weight: bold">Tên chuyên mục </th>
													<th style="font-weight: bold">Cấp cha </th>
                                                    <th style="font-weight: bold">Thứ tự</th>
                                                    <th style="font-weight: bold">Trạng thái</th>
                                                    <th style="font-weight: bold">Trang chủ</th>
                                                     <th style="font-weight: bold">Danh sách - Trang chủ</th>
                            ...
                            <td>
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                     ...
                                     <tr >
                                      ...
                                      <tr >
                                        <td align="left"><span style=" color:#ff0000">Icon menu</span>
                                        </td>
                                        <td></td>
                                        <td>
                                                <asp:TextBox ID="txtImage1" runat="server" CssClass="text image"></asp:TextBox>
                                                <input id="btnImage1" type="button" onclick="BrowseServer('<%=txtImage1.ClientID %>','News');" value="Browse Server" class="toolbar btns btn-info" />
                                                <asp:Literal ID="ltimgs1" runat="server"></asp:Literal>
                                                <asp:HiddenField ID="hdimgnews1" runat="server" />
                                           <div style="font-size: 8pt; color: #ed1c24"><em>(Kích thước ảnh: Rộng: 100px X Cao: (Tùy ý) Hoặc 50px)</em></div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr >
                                        ...
                                        <td></td>
                                        <td>
                                            <asp:CheckBox ID="chknews"  CssClass="CsCheckBox" runat="server" Text="Show dưới danh sách" />
