 ...
 collapse;width:569pt" width="758">
  ...
  height:73px">
        ...
        <td class="style4" colspan="5" rowspan="3">
           <%=MoreAll.Other.Giatri("FooTer")%></td>
	...
	<ItemTemplate>
      <tr height="28" style="mso-height-source:userset;height:21.0pt">
        ...
        <td class="style26"  style='border:1px solid #000'><%=MoreAll.Other.Giatri("Dongiapro") %></td>
        <td class="style27" width="65"  style='border:1px solid #000'><%#MoreAll.MorePro.Detail_Price(Eval("Price").ToString())%> <%=MoreAll.Other.Giatri("Dongiapro") %></td>
        <td class="style28" width="76"  style='border:1px solid #000'><%#MoreAll.MorePro.Detail_Price(Eval("Money").ToString())%> <%=MoreAll.Other.Giatri("Dongiapro") %></td>
    ...
    <tr height="33" style="mso-height-source:userset;height:24.75pt">
        ...
        <td class="style34" colspan="1">
            <asp:Literal ID="lttong" runat="server"></asp:Literal> <%=MoreAll.Other.Giatri("Dongiapro") %></td>
        <td class="style8">
        </td>
    </tr>
