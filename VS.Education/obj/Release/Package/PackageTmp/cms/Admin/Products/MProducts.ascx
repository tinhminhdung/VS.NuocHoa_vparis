                        ...
                        <div class="span12">
                            <div class="widget">
                                ...
                                <div class="widget-body">
                                    ...
                                    <div style=" color:red; font-size:14px">Chú ý: Thành viên phải mua sản phẩm chiến lược thì mới được hoa hồng</div>
                                     <div style=" color:red; font-size:14px">Chú ý: Sản phẩm chiến lược lấy giá bán ra chia hoa hồng</div>
                                       <div style=" color:red; font-size:14px">Chú ý: Sản phẩm Thông thường lấy giá lợi nhuận ra chia hoa hồng</div>
                                    <div class="list_item">
                                        <asp:Repeater ID="rpitems" runat="server" OnItemCommand="rpitems_ItemCommand1">
                                            <ItemTemplate>
                                                <tr height="40">
                                                    ...
                                                    <td>
                                                        <div style=" margin-bottom:4px;"><span style=" width:15px;">Giá Nhập: </span><asp:TextBox ID="txtgiacu" Style="width:100px;text-align: center;" Text='<%#MoreAll.MorePro.FormatMoney_Cart(Eval("OldPrice").ToString())%>' onkeyup="valid(this,'quotes')" onblur="valid(this,'quotes')" CssClass="txt_css" runat="server" OnTextChanged="txtgiacu_TextChanged" AutoPostBack="true"></asp:TextBox></div>
                                                        <div><span style=" width:15px;">Giá Bán: </span><asp:TextBox ID="txtgiaban" Style="width:100px;text-align: center;"  Text='<%#MoreAll.MorePro.FormatMoney_Cart(Eval("Price").ToString())%>' onkeyup="valid(this,'quotes')" onblur="valid(this,'quotes')" CssClass="txt_css" runat="server" OnTextChanged="txtgiaban_TextChanged" AutoPostBack="true"></asp:TextBox></div>

                                                        <div class="Chuaxuly" style="margin-top:2px;">Lợi nhuận: <%#MoreAll.MorePro.FormatMoney_Cart(Commond.Tinh_TienLoiNhuan(Eval("Price").ToString(),Eval("OldPrice").ToString()))%></div>
                                                    </td>
                                                    <td style="text-align: center;">
                                                    ...
                                                    <td style="text-align: center;">
                                                        <%--  <%#MoreImages(Eval("ipid").ToString(), Eval("icid").ToString())%><br />--%>
                                                ...
                                                <table cellspacing="0" style="border-collapse: collapse; margin-top: 18px" class="table table-striped table-bordered dataTable table-hover">
                                                    <tr class="trHeader" style="height: 25px">
                                                      ...
                                                      <%--  <td class="header">Số lượng</td>--%>
                                                        ...
                                                        <td class="header">Sp chiến lược</td>
                                                         <td class="header">Hot</td>
                                                         <td class="header">Nổi bật</td>
                                                         <td class="header">Khuyễn mãi</td>
                                                        <td class="header">Bán</td>
                    ...
                    <div class="widget-body widget">
                        ...
                        <div class='frm-add'>
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td style="height: 19px; color: #6d6d6d">
                                        Phân loại nhóm</td>
                                    <td></td>
                                    <td>
                             ...
                             <tr style=" display:none">
                                ...
                                <tr>
                                    ...
                                    <td style="height: 18px">
                                        ...
                                        <input id="btnImage" type="button" onclick="BrowseServer('<%=txtImage.ClientID %>','News');" value="Browse Server" class="toolbar btns btn-info" />
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr valign="top">
                                                <td style="width: 150px">
                                                    <asp:TextBox ID="txtprice" runat="server" Width="112px" ValidationGroup="GInfo" CssClass="txt_css">0</asp:TextBox>
                                                    <%--<%=MoreAll.MorePro.Dongiapro()%>--%><cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" FilterType="Numbers" TargetControlID="txtprice"></cc1:FilteredTextBoxExtender>
                                                          <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ValidationGroup="GInfo" ControlToValidate="txtprice" ErrorMessage="*" ></asp:RequiredFieldValidator>

                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtoldprice" runat="server" Width="112px" ValidationGroup="GInfo" CssClass="txt_css"></asp:TextBox>&nbsp;<%--<%=MoreAll.MorePro.Dongiapro()%>--%>&nbsp;&nbsp; &nbsp; &nbsp;<cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server" FilterType="Numbers" TargetControlID="txtoldprice"></cc1:FilteredTextBoxExtender>
                                                          <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ValidationGroup="GInfo" ControlToValidate="txtoldprice" ErrorMessage="*" ></asp:RequiredFieldValidator>
                ...
                <asp:TextBox ID="txtindays" runat="server" CssClass="txt" Width="48px">365</asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:CheckBox ID="Check_01"  CssClass="txt_css2" runat="server" Font-Bold="False" Text="Sản phẩm hot" />
                                        <asp:CheckBox ID="Check_02"  CssClass="txt_css2" runat="server" Font-Bold="False" Text="Sản phẩm nổi bật" />
                                        <asp:CheckBox ID="Check_03"  CssClass="txt_css2" runat="server" Font-Bold="False" Text="Sản phẩm khuyến mại" />
                                        <asp:CheckBox ID="Check_04"  CssClass="txt_css2" runat="server" Font-Bold="False" Text="Sản phẩm bán nhiều nhất" />
                        ...
                        <div style="padding-left: 120px;">
                            <asp:LinkButton ID="btnsave" runat="server" ValidationGroup="GInfo" OnClick="btnsave_Click" CssClass="toolbar btn btn-info"> <i class="icon-ok"></i>Cập nhật </asp:LinkButton>
