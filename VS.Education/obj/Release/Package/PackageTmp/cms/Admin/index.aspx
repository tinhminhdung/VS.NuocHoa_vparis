<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="VS.E_Commerce.cms.Admin.index1" %>
                ...
                <asp:Repeater ID="rp_pagelist" runat="server" OnItemCommand="rp_pagelist_ItemCommand">
                    <ItemTemplate>
                       <tr style="background-color:#fcf0e0"  height="40">
                            ...
                            <td align="center">
                                <asp:LinkButton ID="LinkButton1" CommandName="EditDetail" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"ID")%>' runat="server">[Hiệu chỉnh]</asp:LinkButton>
                            </td>
                            <td align="center">
                                <div class="del"><asp:LinkButton CommandName="Delete" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"ID")%>' runat="server" ID="Linkbutton3" OnLoad="Delete_Load">[Xóa]</asp:LinkButton></div>
                            </td>
                        </tr>
                    </ItemTemplate>
