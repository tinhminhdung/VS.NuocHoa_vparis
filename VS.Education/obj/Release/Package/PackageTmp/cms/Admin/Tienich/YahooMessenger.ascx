            ...
            <td>
                ...
                <br /><br /><div  class="adaidien"><asp:Literal ID="ltimg" runat="server"></asp:Literal></div></td>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td>
                                                    <asp:LinkButton ID="btn_InsertUpdate" runat="server" OnClick="btn_InsertUpdate_Click" CssClass="btn btn-primary"> <i class="icon-pencil icon-white"></i> Cập nhật </asp:LinkButton>
