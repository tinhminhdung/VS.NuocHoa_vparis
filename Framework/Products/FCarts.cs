...
namespace Framwork
{
    public class FCarts
    {
        ...
        #region Insert
        public static int Insert(string Name, string Address, string Phone, string Email, string Contents, string Money, string lang, string Status, string Phuongthucthanhtoan, string Hinhthucvanchuyen, string StatusGiaoDich, string IDThanhVien, string TienLoiNhuan, string TrangThaiChienLuocVaThongThuong, string ViVipMuaHang, string ViChinhMuaHang)
        {
            using (SqlCommand dbCmd = new SqlCommand("insert Carts values(@Name,@Address,@Phone,@Email,@Contents,getdate(),@Money,@lang,@Status,@Phuongthucthanhtoan,@Hinhthucvanchuyen,@StatusGiaoDich,@IDThanhVien,@TienLoiNhuan,@TrangThaiChienLuocVaThongThuong,@ViVipMuaHang,@ViChinhMuaHang)", Database.Connection()))
            {
                ...
                dbCmd.Parameters.Add(new SqlParameter("@TienLoiNhuan", TienLoiNhuan));
                dbCmd.Parameters.Add(new SqlParameter("@TrangThaiChienLuocVaThongThuong", TrangThaiChienLuocVaThongThuong));
                dbCmd.Parameters.Add(new SqlParameter("@ViVipMuaHang", ViVipMuaHang));
                dbCmd.Parameters.Add(new SqlParameter("@ViChinhMuaHang", ViChinhMuaHang));
