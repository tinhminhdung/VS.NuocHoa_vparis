...
namespace Framework
{
    public class FMenu
    {
        ...
        public List<Menu> Menu_ExitstByLevel(string Level)
        {
            int n = Level.Length;
            SqlConnection conn = Database.Connection();
            SqlCommand comm = new SqlCommand("select * from Menu where Level <> '" + Level + "' and substring(Level, 1, " + n.ToString() + ") = '" + Level + "' and capp='MN'", conn);
